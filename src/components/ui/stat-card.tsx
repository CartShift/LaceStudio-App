...
export function StatCard({
  ...
  return (
    <EditorialCard className="rounded-[1.5rem] p-4">
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-3">
          <Badge tone={tone}>{label}</Badge>
          <p className="font-display text-[clamp(1.75rem,3.4vw,2.45rem)] font-bold leading-[0.92] tracking-[-0.05em] tabular-nums">
            {value}
          </p>
        </div>
