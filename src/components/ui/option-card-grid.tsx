			...
			{options.map(opt => {
				return (
					<ToggleGroupItem
						...
						className={cn(
							"group relative h-auto w-full min-w-0 flex-col items-center overflow-hidden rounded-xl border text-center whitespace-normal shadow-none transition-[transform,box-shadow,border-color,background-color,color] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-[color:color-mix(in_oklab,var(--ring),transparent_58%)] focus-visible:ring-offset-2 focus-visible:ring-offset-background",
